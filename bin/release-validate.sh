...
require_file "$root/bin/disasm-external-compare.sh"
require_file "$root/bin/disassembler-v2-alpha-validate.sh"
require_file "$root/bin/disassembler-v2-alpha-validate-test.sh"
require_file "$root/bin/release-package.sh"
require_file "$root/bin/render-release-notes.sh"
require_file "$root/bin/shared-cache-evidence-audit.sh"
require_file "$root/bin/shared-cache-evidence-audit-test.sh"
require_file "$root/bin/shared-cache-evidence-package.sh"
require_file "$root/bin/shared-cache-evidence-package-test.sh"
require_file "$root/bin/shared-cache-real-smoke.sh"
