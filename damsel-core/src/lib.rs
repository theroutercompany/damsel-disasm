...
pub use model::{
    ...
    CompatibilityCapabilityRole, CompatibilityIssue, DecodedInstruction, DisassemblyLimit,
    ...
    ExportFlagName, ExportFlags, ExportKind, ExportRecord, ExportedSymbol, HostArchitecture,
    HostPlatform, Import, ImportBindingKind, ImportBindingRecord, ImportBindingSource,
    IndirectTargetReason, ObjcCategoryRecord, ObjcCategoryRecordSource, ObjcClassRecord,
    ObjcIvarRecord, ObjcMetadata, ObjcMethodOwnerKind, ObjcMethodRecord, ObjcNameSource,
    ObjcPointerKind, ObjcPointerRef, ObjcPropertyRecord, ObjcProtocolRecord, ObjcSelectorSource,
    Operand, Platform, RecoveredValue, RecoveredValueKind, RecoveredValueSource, Reference,
    Relocation, RelocationEncodingId, RelocationKindId, RelocationTargetKind, Section, SectionKind,
