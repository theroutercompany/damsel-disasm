...
pub use model::{
    ...
    CompatibilityIssue, DecodedInstruction, DisassemblyLimit, DisassemblyOptions,
    ...
    SliceInfo, StubEntry, StubHelperEntry, StubKind, Symbol, SymbolKind, TableSlotEncoding,
};
