...
pub use model::{
    ...
    ObjcSelectorSource, Operand, Platform, ProjectedBinaryImage, ProjectedImageProvenance,
    ...
    SharedCache, SharedCacheBuilder, SharedCacheHeader, SharedCacheMapping, SharedCacheMember,
