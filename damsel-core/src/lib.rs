...
pub use model::{
    ...
    BinaryImageValidationError, BinarySource, CapabilityStatus, CompatibilityIssue,
    DecodedInstruction, DisassemblyLimit, DisassemblyOptions, DisassemblyRequest,
    DisassemblyRequestV2, DisassemblyResult, DisassemblyResultV2, DisassemblyStopReason,
    DisassemblyTarget, DyldMetadata, Endianness, ExportFlagName, ExportFlags, ExportKind,
    ExportRecord, ExportedSymbol, HostArchitecture, HostPlatform, Import, ImportBindingKind,
    ImportBindingRecord, ImportBindingSource, IndirectTargetReason, ObjcCategoryRecord,
    ObjcCategoryRecordSource, ObjcClassRecord, ObjcIvarRecord, ObjcMetadata, ObjcMethodOwnerKind,
    ObjcMethodRecord, ObjcNameSource, ObjcPointerKind, ObjcPointerRef, ObjcPropertyRecord,
    ObjcProtocolRecord, ObjcSelectorSource, Operand, Platform, RecoveredValue, RecoveredValueKind,
